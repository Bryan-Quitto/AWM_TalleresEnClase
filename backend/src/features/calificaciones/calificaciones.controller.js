// =============================================================================
// Slice: calificaciones — controller (rutas CRUD + vista estudiante)
// =============================================================================

const express = require("express");
const wrap = require("../../common/errors");
const { requireAuth, requireRole } = require("../../common/middleware/auth");
const svc = require("./calificaciones.service");
...
router.get(
  ...
  wrap(async (req, res) => {
    ...
    if (!c) return res.status(404).json({ error: "Calificación no encontrada" });
    res.json(c);
  })
);
...
// =============================================================================
// Vista del estudiante — se monta por separado en /api/estudiantes/:id/...
// =============================================================================
